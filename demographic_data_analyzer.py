...
def calculate_demographic_data(print_data=True):
    ...
    percentage_bachelors = round((df['education'].tolist().count('Bachelors')/len(df.index))*100,1)
    ...
    lower_education = len(df.index) - higher_education
    ...
    min_work_hours = min(df['hours-per-week'].tolist())
